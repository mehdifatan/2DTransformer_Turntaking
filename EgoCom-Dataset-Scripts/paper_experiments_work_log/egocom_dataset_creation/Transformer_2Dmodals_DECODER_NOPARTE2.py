...
from vocalist.models.transformer_encoder_decoder import TransformerEncoder
...
class MyEnsemble(nn.Module):
    def __init__(self, model1, model2, model3,model1_2, model3_2):
        ...
        self.linear = nn.Linear(1536,4).float().to(device)
    ...
    def forward(self, src1, src2, src3, src_att1, src_att2, src_att3, target_input, trg_att):
        ...
        '''
        src_pred = torch.ones((pred1.shape[0], 1,pred1.shape[1])).to(device)
        
        
        #pred1_2 = self.model1_2(pred1,pred2,pred2)
        #pred3_2 = self.model3_2(pred3,pred2,pred2)
        
        #pred1_2 = self.model1_2(pred1, target_input,src_pred, trg_att, pred2,pred2)
        #pred3_2 = self.model3_2(pred3, target_input,src_pred, trg_att, pred2,pred2)
        #pred1=torch.cat((pred1_2, pred3_2), 2)
        pred1_2 = self.model1_2(pred1, target_input,src_pred, trg_att, pred2, pred2)
        pred3_2 = self.model3_2(pred3, target_input,src_pred, trg_att, pred2, pred2)
        '''
        pred1_2_3=torch.cat((pred1, pred2, pred3), 2)       
        pred=self.linear(pred1_2_3)
...
log_file='log_run1_HT_NT_pre_DECODER.txt'
...
for include_prior in include_prior_list:
    ...
    for history_sec in history:
        ...
        for future_pred in future:
                ...
                optim1 = NoamOpt(512, 1., len(x_tr_dl)*warmup,torch.optim.Adam(model.parameters(), lr=0.01, betas=(0.9, 0.98), eps=1e-9, weight_decay=1e-7))
